...
| M1 | 评测集与检索实验 | 14-18h | T4 待做 | [M1](plans/M1-evaluation.md) |
| M2 | 基础设施：PG + Redis + 异步摄入 | 8-10h | 未开始 | 待写 |
...
待做：
- **T4 生成层评测**：Ragas 的 faithfulness / answer_relevancy /
  answer_correctness，必须人工抽检 20-30 条并报一致率
